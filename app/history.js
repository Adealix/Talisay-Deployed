...
const styles = StyleSheet.create({
  ...
  dsExpandBtnText: { fontSize: 11, fontWeight: '600' },
  ...
  dsCompactView: { gap: 6 },
  dsCompactDims: { flexDirection: 'row', gap: 4 },
  dsCompactDimItem: { flex: 1, paddingVertical: 6, borderRadius: BorderRadius.sm, alignItems: 'center', gap: 1 },
  dsCompactDimVal: { fontSize: 13, fontWeight: '700' },
  dsCompactDimLbl: { fontSize: 8, fontWeight: '500' },
  dsCompactInterp: { fontSize: 10, lineHeight: 15, padding: 6, borderRadius: BorderRadius.sm },
  compSummaryBox: {
